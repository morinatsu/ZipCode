...
class TestMakeLoaddata(unittest.TestCase):
    ...
    def test_dup(self):
        ...
        self.assertEqual(output,
                         [u"01230", u"059  ", u"0590005", u"ホッカイドウ",
                          u"ノボリベツシ",
                          u"サツナイチョウ(5、9、11-12、36、42-2、62、80、"
                          u"95、184、231、389-2、499、500バンチ)",
                          u"北海道", u"登別市",
                          u"札内町（５、９、１１−１２、３６、４２−２、６２、"
                          u"８０、９５、１８４、２３１、３８９−２、４９９、"
                          u"５００番地）",
    ...
    def test_divide(self):
        ...
        output = make_loaddata.merge_separated_line(args).next()
        self.assertEqual(output,
                         [[u"23201", u"440  ", u"4400833", u"アイチケン",
                           u"トヨハシシ", u"イムレチョウニシヤマ",
                           u"愛知県", u"豊橋市", u"飯村町西山",
